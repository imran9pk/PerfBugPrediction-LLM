...
class ClassDiff {
    ...
    public ClassDiff(String name) {
        ...
        ctorsAdded = new ArrayList(); ctorsRemoved = new ArrayList(); ctorsChanged = new ArrayList(); methodsAdded = new ArrayList(); methodsRemoved = new ArrayList(); methodsChanged = new ArrayList(); fieldsAdded = new ArrayList(); fieldsRemoved = new ArrayList(); fieldsChanged = new ArrayList(); }   

...
public class TransferObserverV1
    ...
    private static final String[] __className = {"cell",               "domain",             "sequence",           "protocol",           "uid",                "gid",                "vomsGroup",          "process",            "pnfs",               "pool",               "host",               "status",             "waiting",            "state",              "submitted",          "time",               "transferred",        "speed",              "running"             ;

    private static final String[] __listHeader = {"Cell",               "Domain",             "Seq",                "Prot",               "UID",                "GID",                "VOMS Group",         "Proc",               "PnfsId",             "Pool",               "Host",               "State",              "Waiting",            "JobState",           "Submitted",          "Time",               "Trans.&nbsp;(KiB)",   "Speed&nbsp;(KiB/s)",  "Running"             ;
